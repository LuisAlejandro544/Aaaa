...
- 🎬 **Video a Música + Video de Fondo (Canvas Sincronizado Asíncrono)**:
  ...
  - Pantalla modal flotante de carga en tiempo real (`VideoImportProgressModal`) con barra circular que informa el estado del proceso sin congelar el hilo principal de la interfaz de usuario.
