...
4. **Python**: Módulo `python_ai/` preservado para desarrollos y modelos futuros.
...
- Temporizador de Sueño Inteligente (`SleepTimerSheet`) con apagado automático y fade-out progresivo de 15s de volumen.
- Editor Manual de Etiquetas ID3 y Portadas (`EditTrackMetadataDialog`) para personalización de título, artista, álbum, género, mood y portadas WebP.
